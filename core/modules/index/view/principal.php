...
<!-- <body class="hold-transition skin-blue sidebar-mini"> -->
  <body class="<?php if(isset($_SESSION["admin_id"]) || isset($_SESSION["id_usuario"])):?> hold-transition skin-yellow sidebar-mini<?php else:?>login-page<?php endif; ?>" oncopy="return false" onpaste="return false">
<?php 
$u=null;
...
<?php
  ...
  <div class="wrapper">
      ...
      ?>
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?view=periodos"><i class="fa fa-arrows-h"></i>Periodo Alcaldia</a></li>
    ...
    <footer class="main-footer">
      ...
      <strong><b><?php echo $orgs->footer1; ?></b>  &copy; <b>Desarrollado por <B>TAREA COMPLETO</B><?php echo $orgs->footer2; ?></b>  <a href="https://web.facebook.com/pg/Municipalidad-Distrital-de-Acraquia-Oficial-104561077580285/about/?ref=page_internal" target="_blank"> <b><?php echo $orgs->footer3; ?></b></a></strong>
    </footer>
    <?php else:?>
    <?php endif;?>
  </div>
