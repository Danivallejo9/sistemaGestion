...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form>
            <input type="hidden" name="view" value="reportedocumentoperdido">
            <div class="row">
            <div class="col-md-3">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
      ...
      if($_GET["id_archivo"]==""){
      $operations = DocumentoData::getAllByDateOfficiallj($_GET["sd"],$_GET["ed"],2);
      }
      else{
      $operations = DocumentoData::getAllByDateOfficialBPpj($_GET["id_archivo"],$_GET["sd"],$_GET["ed"],2);
      } 
       ?>
