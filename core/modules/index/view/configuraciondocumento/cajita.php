...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="box-body">
          <form class="form-horizontal" method="post" action="index.php?action=actualizardocumento" role="form">
            ...
            <div class="form-group has-feedback has-error">
             ...
             <div class="form-group has-feedback has-error">
              <label for="inputEmail1" class="col-lg-3 control-label">Folio</label>
                <div class="col-lg-9">
            ...
            <div class="form-group has-feedback has-error">
              <label for="inputEmail1" class="col-lg-3 control-label">Ubicacion</label>
                <div class="col-lg-9">
            ...
            <div class="form-group has-feedback has-error">
              <div class="col-lg-offset-3 col-lg-2">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="publico" id="publico" <?php if($archivos->publico){ echo "checked";} ?> > Publico
                    </label>
                  </div>
              </div>
              ...
              <div class="col-lg-offset-1 col-lg-2">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="perdido" id="perdido" <?php if($archivos->perdido){ echo "checked";} ?> > Perdido
                    </label>
                  </div>
              </div>
            </div>
     ...
     <?php if($u->encargado):?> <p class='alert alert-danger'><i class="fa fa-exclamation-triangle"></i> !Tenga mucho cuidado cualquier cambio estará figurando a su nombre!</p><?php endif; ?>
    <!-- </section> -->
              </div>
            </div>
          </div>
