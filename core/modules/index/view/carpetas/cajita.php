            ...
            if(count($carpetas)>0){
              ...
              foreach($carpetas as $ver){
                ...
                <td style="width:180px;">
                  <a href="index.php?view=configuracioncarpetaarea&id_carpeta=<?php echo $car->id_carpeta;?>&tid=<?php echo $team->id_area_oficina;?>" class="btn btn-success btn-sm btn-flat"><i class='fa fa-cog'></i> Actualizar</a>
                  <a href="index.php?action=eliminarcarpetaarea&id_carpeta=<?php echo $car->id_carpeta;?>&tid=<?php echo $team->id_area_oficina;?>" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i> Eliminar</a>
                </td>
                </tr>
                <?php
          ...
          <?php
            ...
            if(count($carpetas)>0){
              ...
              foreach($carpetas as $ver){
                ...
                <td style="width:80px;">
                  <a href="index.php?view=configuracioncarpetaarea&id_carpeta=<?php echo $car->id_carpeta;?>&tid=<?php echo $team->id_area_oficina;?>" class="btn btn-success btn-sm btn-flat"><i class='fa fa-cog'></i> Actualizar</a>
                  <!-- <a href="#" title="Usted se encuentra en modo Encargado y no puede Eliminar" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i> Eliminar</a> -->
                </td>
                </tr>
                <?php
