  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1><i class="fa fa-server"></i>
        LISTA DE LOS PERIODOS DE ALCALDIA 
        <small></small>
      </h1>
      <!-- <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <h3 class="box-title"><b>Todos los Periodos Registrados</b></h3>
        ...
        <div class="box-body">
          <div class="table-responsive">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td style="width:10px;"><a href="index.php?action=seleccionperiodo&id_periodo=<?php echo $periodo->id_periodo;?>" class="btn btn-success btn-xs">Seleccionar <i class="fa fa-arrow-right"></i></a></td>
                      <td><a href=""><a href="./?view=periodo&id_periodo=<?php echo $periodo->id_periodo;?>"><?php echo $periodo->nombre; ?></a></td>       
                      <td style="width:10px;">
                        <a data-toggle="modal" href="#edit-<?php echo $periodo->id_periodo;?>" class="btn btn-warning btn-xs"> <i class="fa fa-cog"></i> Configuracion</a>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <center><h4 class="modal-title"><i class="fa fa-arrows-h"></i><b> Actualizacion del Periodo <?php echo $periodo->nombre ?></b></h4></center>
                                  </div>
                                  <div class="modal-body">
                                    <form class="form-horizontal" method="POST" action="index.php?action=actualizarperiodo">
                                      ...
                                      <div class="col-lg-offset-12 col-lg-12">
                                        <div class="checkbox">
                                          <label>
                                            <input type="checkbox" name="activo"<?php if($periodo->activo){ echo "checked";} ?>> Activo
                                          </label>
                                        </div>
                                      </div>
                                    </div>
        ...
        <div class="box-body">
          <div class="table-responsive">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td style="width:10px;"><a href="index.php?action=seleccionperiodoo&id_periodo=<?php echo $periodo->id_periodo;?>" class="btn btn-success btn-xs">Seleccionar <i class="fa fa-arrow-right"></i></a></td>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <h3 class="box-title"><b>Todos los Periodos Registrados</b></h3>
          <div class="box-tools pull-left">
            <a href="#" title="Estimado encargado no puedes Registrar" alert="Estimado encargado no puedes Registrar" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nuevo Periodo</a>
            <a href="index.php?view=periodos" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i></a>
          </div>
        </div>
        <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a href=""><a href="./?view=periodo&id_periodo=<?php echo $periodo->id_periodo;?>"><?php echo $periodo->nombre; ?></a></td>       
                      <td style="width:10px;">
                        <a data-toggle="modal" href="#" title="Estimado encargado no puedes modificar" class="btn btn-warning btn-xs"> <i class="fa fa-cog"></i> Configuracion</a>
                        <!-- Actualizacion del Periodo -->
                        <div class="modal fade" id="edit-<?php echo $periodo->id_periodo;?>">
                          <div class="modal-dialog">
                              <div class="modal-content">
