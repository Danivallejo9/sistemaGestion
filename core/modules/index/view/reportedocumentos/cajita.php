...
<!--       <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form>
            <input type="hidden" name="view" value="reportedocumentos">
            <div class="row">
            <div class="col-md-3">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
      ...
      if($_GET["id_archivo"]==""){
      $operations = DocumentoData::getAllByDateOfficial($_GET["sd"],$_GET["ed"],2);
      }
      else{
      $operations = DocumentoData::getAllByDateBCOpp($_GET["id_archivo"],$_GET["sd"],$_GET["ed"],2);
      } 
       ?>
